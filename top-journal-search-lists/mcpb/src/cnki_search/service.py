...
_CHALLENGE_WARNING = (
    "知网安全验证已阻止本次检索；已停止请求，请不要刷新、重试或切换代理。"
    "可继续使用 ai4scholar，或在浏览器手动检索下载。"
)

_SHORT_WARNINGS = {
    SearchStatus.LOGIN_REQUIRED: "需要登录",
    SearchStatus.FORBIDDEN: "访问被拒绝",
    SearchStatus.RATE_LIMITED: "访问频繁",
    SearchStatus.PAGE_CONTRACT_CHANGED: "页面结构变化",
    SearchStatus.CONFIGURATION_ERROR: "配置错误",
    SearchStatus.NETWORK_ERROR: "网络错误",
}
...
class CnkiPublicSearchService:
    def __init__(
        self,
        *,
        session_factory=PublicCnkiSession,
        catalog: Path = DEFAULT_CATALOG,
        cache: SearchCache | None = None,
        gate: SerialSearchGate | None = None,
    ) -> None:
    ...
    def search(self, query: str, limit: int = 20) -> SearchOutcome:
        ...
        try:
            ...
            return empty_outcome(
                ...
                request.query,
                _SHORT_WARNINGS[SearchStatus.CONFIGURATION_ERROR],
            )
            ...
            try:
                ...
                if status is SearchStatus.NO_RESULTS:
                    ...
                    outcome = SearchOutcome(
                        ...
                        request.query,
                        records,
                        parsed.incomplete_records,
                        parsed.excluded_non_journal_rows,
                        [],
                        utc_now(),
                    )
                ...
                return empty_outcome(
                    ...
                    request.query,
                    _SHORT_WARNINGS[SearchStatus.PAGE_CONTRACT_CHANGED],
                )
                ...
                if attempt == 1:
                    return empty_outcome(
                        ...
                        request.query,
                        _SHORT_WARNINGS[SearchStatus.NETWORK_ERROR],
                    )
